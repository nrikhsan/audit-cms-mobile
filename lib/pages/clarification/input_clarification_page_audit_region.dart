...
//audit area
class InputClarificationAuditArea extends StatefulWidget {
  final int id;
  const InputClarificationAuditArea({super.key, required this.id});

  @override
  State<InputClarificationAuditArea> createState() => _InputClarificationAuditAreaState();
}

class _InputClarificationAuditAreaState extends State<InputClarificationAuditArea> {
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                      ...
                      if (limitEvaluation.isEmpty || locationInspection.isEmpty || divisionInspection.isEmpty || supervisor.isEmpty || desc.isEmpty || selectPriority == null) {
                        ...
                        controllerAuditArea.inputClarificationAuditArea(widget.id, limitEvaluation, locationInspection, divisionInspection, supervisor, desc, selectPriority);
                        Get.back();
                      }
                    }, 
