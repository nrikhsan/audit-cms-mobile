                                ...
                                children: [
                                  ...
                                  TextButton(
                                      style: TextButton.styleFrom(
                                          shape: CustomStyles.customRoundedButton),
                                      onPressed: () {
                                        Get.to(() => DetaiCasesLhaPageAuditRegion(lhaId: lha[index].id!));
                                      },
                                      child: Text('Lihat rincian', style: CustomStyles.textMediumGreen15Px))
                                ],
                              )
...
class DetaiCasesLhaPageAuditRegion extends StatefulWidget {
  ...
  @override
  State<DetaiCasesLhaPageAuditRegion> createState() => _DetailCasesLhaPageAuditRegionState();
}

class _DetailCasesLhaPageAuditRegionState extends State<DetaiCasesLhaPageAuditRegion> {
  final ControllerAuditRegion controllerAuditRegion = Get.put(ControllerAuditRegion(Get.find()));
  @override
  Widget build(BuildContext context) {
