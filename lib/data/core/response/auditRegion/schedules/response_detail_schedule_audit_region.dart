class ResponseDetailScheduleAuditRegion {
  ...
  int? status;
  String? message;
  ModelDetailSchedulesAuditRegion? dataSchedules;
  ...
  ResponseDetailScheduleAuditRegion.fromJson(Map<String, dynamic> json) {
    ...
    dataSchedules = json['data_schedules'] != null
        ? new ModelDetailSchedulesAuditRegion.fromJson(json['data_schedules'])
        : null;
  }
...
class ModelDetailSchedulesAuditRegion {
  int? id;
  String? auditor;
  String? area;
  String? branch;
  ...
  ModelDetailSchedulesAuditRegion(
      {this.id,
        this.auditor,
        this.area,
        this.branch,
  ...
  ModelDetailSchedulesAuditRegion.fromJson(Map<String, dynamic> json) {
    id = json['id'];
