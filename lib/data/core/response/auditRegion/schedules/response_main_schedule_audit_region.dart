...
class Data {
  List<ContentMainScheduleAuditRegion>? content;
  Pageable? pageable;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['content'] != null) {
      content = <ContentMainScheduleAuditRegion>[];
      json['content'].forEach((v) {
        content!.add(new ContentMainScheduleAuditRegion.fromJson(v));
      });
    }
...
class ContentMainScheduleAuditRegion {
  User? user;
  Branch? branch;
  int? id;
  String? description;
  ...
  ContentMainScheduleAuditRegion(
      {this.user,
      this.branch,
      this.id,
      this.description,
  ...
  ContentMainScheduleAuditRegion.fromJson(Map<String, dynamic> json) {
