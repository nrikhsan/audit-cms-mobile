class ResponseInputClarificationAuditRegion {
  int? status;
  String? message;

  ResponseInputClarificationAuditRegion({this.status, this.message});

  ResponseInputClarificationAuditRegion.fromJson(Map<String, dynamic> json) {
    status = json['status'];
