class ResponseDetailLhaAuditRegion {
  ...
  int? status;
  String? message;
  ModelDetailLhaAuditRegion? dataDetailLha;

  ResponseDetailLhaAuditRegion(
  ...
  ResponseDetailLhaAuditRegion.fromJson(Map<String, dynamic> json) {
    ...
    dataDetailLha = json['data_detail_lha'] != null
        ? new ModelDetailLhaAuditRegion.fromJson(json['data_detail_lha'])
        : null;
  }
...
class ModelDetailLhaAuditRegion {
  int? id;
  String? auditor;
  String? inputDate;
  String? branch;
  ...
  ModelDetailLhaAuditRegion.fromJson(Map<String, dynamic> json) {
    id = json['id'];
