class ResponseMainScheduleAuditArea {
  ...
  int? status;
  String? message;
  List<ModelMainSchedulesAuditArea>? mainSchedules;
  ...
  ResponseMainScheduleAuditArea.fromJson(Map<String, dynamic> json) {
    ...
    if (json['main_schedules'] != null) {
      mainSchedules = <ModelMainSchedulesAuditArea>[];
      json['main_schedules'].forEach((v) {
        mainSchedules!.add(new ModelMainSchedulesAuditArea.fromJson(v));
      });
    }
  }
...
class ModelMainSchedulesAuditArea {
  int? id;
  String? auditor;
  String? area;
  String? branch;
  ...
  ModelMainSchedulesAuditArea.fromJson(Map<String, dynamic> json) {
    id = json['id'];
