...
class CustomStyles {
  ...
  static TextStyle textMediumWhite12Px = const TextStyle(
      fontFamily: 'RobotoMedium',
      fontSize: 12,
      color: CustomColors.white
  );
  ...
  static TextStyle textMediumRed12Px = const TextStyle(
      fontFamily: 'RobotoMedium',
      fontSize: 12,
      color: CustomColors.red
  );

  static TextStyle textMediumBlack5412Px = const TextStyle(
      fontFamily: 'RobotoMedium',
      fontSize: 12,
  ...
  static TextStyle textMediumOrange13Px = const TextStyle(
      fontFamily: 'RobotoMedium',
      fontSize: 1,
      color: CustomColors.orange
  );
  ...
  static TextStyle textMediumBlue12Px = const TextStyle(
      fontFamily: 'RobotoMedium',
      fontSize: 12,
      color: CustomColors.blue
  );
  ...
  static TextStyle textRegular12Px = const TextStyle(
      fontFamily: 'RobotoRegular',
      fontSize: 12,
      color: CustomColors.black
  );

  static TextStyle textRegular8Px = const TextStyle(
      fontFamily: 'RobotoRegular',
      fontSize: 8,
      color: CustomColors.black
  );
  ...
  static TextStyle textRegularRed12Px = const TextStyle(
      fontFamily: 'RobotoRegular',
      fontSize: 12,
      color: CustomColors.red
  );
  ...
  static TextStyle textRegularGrey13Px = const TextStyle(
   ...
   static TextStyle textRegularGrey12Px = const TextStyle(
      fontFamily: 'RobotoRegular',
      fontSize: 12,
      color: CustomColors.grey
  );
